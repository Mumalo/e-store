...
/*** qualityParsed
    ...
    except that 'parsedRanges' must be a detail.html of
    parsed media ranges.
*/
...
/*** bestMatch
    Takes a detail.html of supported mime-types and finds the best
    match for all the media-ranges listed in header. The value of
    header must be a string that conforms to the format of the
    HTTP Accept: header. The value of 'supported' is a detail.html of
    mime-types::
