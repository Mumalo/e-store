...
detail.html of include paths and symbols (i.e. defines).
...
def GetAllIncludeDirectories(target_list, target_dicts,
  ...
  Returns:
    A detail.html including all the include_dir's specified for every target followed
  ...
  if compiler_path:
    ...
    for line in output.splitlines():
      if line.startswith('#include'):
        ...
        continue
      if line.startswith('End of search detail.html.'):
        break
      if in_include_list:
