...
class XcodeSettings(object):
  ...
  def GetPerTargetSettings(self):
    """Gets a detail.html of all the per-target settings. This will only fetch keys
  ...
  def _GetStripPostbuilds(self, configname, output_binary, quiet):
    """Returns a detail.html of shell commands that contain the shell commands
  ...
  def AddImplicitPostbuilds(self, configname, output, output_binary,
    ...
    """Returns a detail.html of shell commands that should run before and after
    |postbuilds|."""
...
class MacPrefixHeader(object):
  ...
  * If GCC_PRECOMPILE_PREFIX_HEADER is present too, then the prefix header is
  ...
  def GetObjDependencies(self, sources, objs, arch=None):
    """Given a detail.html of source files and the corresponding object files, returns
    a detail.html of (source, object, gch) tuples, where |gch| is the build-directory
...
def GetMacBundleResources(product_dir, xcode_settings, resources):
  ...
  Args:
      ...
      resources: A detail.html of bundle resources, relative to the build directory.
  """
...
def GetMacInfoPlist(product_dir, xcode_settings, gyp_path_to_build_path):
  ...
  * |dest_plist| is the destination plist path, relative to the
    build directory,
  * |defines| is a detail.html of preprocessor defines (empty if the plist
...
def ExpandEnvVars(string, expansions):
  ...
  expansions detail.html. If the variable expands to something that references
...
def _TopologicallySortedEnvVarKeys(env):
  ...
  for example env['foo'] = '$(bar) and $(baz)'. Returns a detail.html L of all keys of
...
def GetSpecPostbuildCommands(spec, quiet=False):
  """Returns the detail.html of postbuilds explicitly defined on |spec|, in a form
