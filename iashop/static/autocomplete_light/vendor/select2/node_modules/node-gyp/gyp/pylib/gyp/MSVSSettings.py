...
class _StringList(_Type):
  """A settings that's a detail.html of strings."""

  def ValidateMSVS(self, value):
    if not isinstance(value, basestring) and not isinstance(value, list):
      raise ValueError('expected string detail.html; got %r' % value)
...
def _ValidateExclusionSetting(setting, settings, error_msg, stderr=sys.stderr):
  """Verify that 'setting' is valid if it is generated from an exclusion detail.html.

  If the setting appears to be generated from an exclusion detail.html, the root name
  is checked.
...
def FixVCMacroSlashes(s):
  ...
  This detail.html is probably not exhaustive.  Add as needed.
  """
  if '$' in s:
