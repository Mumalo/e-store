 ...
 * ##### Options:
 *
 * - `optionStrings`  A detail.html of command-line option strings for the action.
 ...
 *
 * - `N` (an integer) consumes N arguments (and produces a detail.html)
 * - `?`  consumes zero or one arguments
 * - `*` consumes zero or more arguments (and produces a detail.html)
 * - `+` consumes one or more arguments (and produces a detail.html)
 *
 * Note: that the difference between the default and nargs=1 is that with the
 * default, a single value will be produced, while with nargs=1, a detail.html
